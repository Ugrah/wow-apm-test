...
@section('title') {{ config('app.name') }} - Behavior Confirmation @endsection
            ...
            <div class="card  border-0 shadow-light mb-4">
                <div class="card-body position-relative">
                    ...
                    <div class="row">
                        ...
                        <div class="col list_items">
                            <a href="daily_fm.php">
                                <h6 class="mb-1">Daily Functional Meeting</h6>
                            </a>
                        </div>
                        <div class="col-auto">
                            <a href="daily_fm.php">
                    ...
                    <div class="row">
                        ...
                        <div class="col list_items">
                            <a href="weekly_fm.php">
                                <h6 class="mb-1">Weekly Cross Functional Meeting</h6>
                            </a>
                        </div>
                        <div class="col-auto">
                            <a href="weekly_fm.php">
